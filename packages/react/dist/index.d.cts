...
declare function Center({ children, className, style, width, height, inline, ...props }: CenterProps): react.JSX.Element;

export { type AlignItems, type AsProp, type BaseProps, Box, type BoxProps, Button, type ButtonProps, Center, type CenterProps, Container, type ContainerProps, Divider, type DividerOrientation, type DividerProps, Flex, type FlexDirection, type FlexProps, type FlexWrap, type JustifyContent, type PolymorphicProps, Spacer, type SpacerProps, Stack, type StackProps, type Theme, breakpoints, colors, durations, easings, opacity, radius, shadows, sizes, spacing, theme, transitions, typography, zIndex };
